...
-- 2. Sản phẩm
INSERT INTO san_pham (ma_sp, ten_sp, don_vi_tinh, gia_nhap_chuan, nguong_ton_kho, hinh_anh_url, trang_thai, ma_danh_muc) VALUES
('SP-SAM-S24U', 'Samsung Galaxy S24 Ultra 512GB', 'Chiếc', 25000000, 5, 'https://cdn.example.com/s24u.jpg', 'DANG_KINH_DOANH', 'DM-DIENTHOAI'),
('SP-APP-IP16P', 'iPhone 16 Pro Max 256GB', 'Chiếc', 29000000, 5, 'https://cdn.example.com/ip16pm.jpg', 'DANG_KINH_DOANH', 'DM-DIENTHOAI'),
('SP-SAM-BUDS3', 'Tai nghe Galaxy Buds 3 Pro', 'Bộ', 5000000, 10, 'https://cdn.example.com/buds3.jpg', 'DANG_KINH_DOANH', 'DM-TAINGHE'),
('SP-LOGI-MX3S', 'Chuột Logitech MX Master 3S', 'Chiếc', 1800000, 8, 'https://cdn.example.com/mx3s.jpg', 'DANG_KINH_DOANH', 'DM-PHUKIEN'),
('SP-DELL-P24', 'Màn hình Dell UltraSharp U2424H', 'Chiếc', 4800000, 4, 'https://cdn.example.com/u2424h.jpg', 'DANG_KINH_DOANH', 'DM-MAYTINH');
...
-- 9. Phiếu xuất kho mẫu (Xuất chuyển kho)
INSERT INTO phieu_xuat_kho (ma_phieu_xuat, ma_kho, ma_nv_xuat, ly_do_xuat, tong_gia_tri, ghi_chu, trang_thai) VALUES
('PXK-2026-301', 'KHO-HN-01', 'NV003', 'CHUYEN_KHO', 125000000, 'Điều chuyển hàng từ Kho HN sang Kho SG', 'DA_XAC_NHAN');

INSERT INTO muc_xuat_kho (ma_phieu_xuat, ma_sp, so_luong_yeu_cau, so_luong_thuc_xuat, don_gia_xuat, thanh_tien) VALUES
('PXK-2026-301', 'SP-SAM-S24U', 5, 5, 25000000, 125000000);