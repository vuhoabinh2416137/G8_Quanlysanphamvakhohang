# BTL-IT3120: Phân tích & Thiết kế Hệ thống Quản lý Sản phẩm và Kho hàng
...
> **Chủ đề**: Hệ thống Quản lý Sản phẩm và Kho hàng (Tập trung Sản phẩm, Nhập/Xuất kho, Tồn kho, Mua hàng & Kiểm kê - Không có nghiệp vụ bán hàng).
...
| 04 | Phân tích chức năng | Biểu đồ Hoạt động (Activity Diagrams) | [04-activity-diagrams.md](./docs/04-activity-diagrams.md) | [activity-diagrams.puml](./plantuml/activity-diagrams.puml) | [activity-nhap-kho.png](./diagrams/activity-nhap-kho.png)<br>[activity-xuat-kho.png](./diagrams/activity-xuat-kho.png)<br>[activity-kiem-ke-kho.png](./diagrams/activity-kiem-ke-kho.png)<br>[activity-mua-hang.png](./diagrams/activity-mua-hang.png) |
...
| 07 | Phân tích hành vi | Sơ đồ Tuần tự Hệ thống (SSD) | [07-ssd.md](./docs/07-ssd.md) | [ssd.puml](./plantuml/ssd.puml) | [ssd-nhap-kho.png](./diagrams/ssd-nhap-kho.png)<br>[ssd-xuat-kho.png](./diagrams/ssd-xuat-kho.png)<br>[ssd-mua-hang.png](./diagrams/ssd-mua-hang.png)<br>[ssd-kiem-ke.png](./diagrams/ssd-kiem-ke.png) |
...
| 09 | Phân tích hành vi | Sơ đồ Máy Trạng thái (State Machine) | [09-state-machine.md](./docs/09-state-machine.md) | [state-machine.puml](./plantuml/state-machine.puml) | [state-don-mua-hang.png](./diagrams/state-don-mua-hang.png)<br>[state-phieu-xuat-kho.png](./diagrams/state-phieu-xuat-kho.png)<br>[state-san-pham.png](./diagrams/state-san-pham.png) |
